...
# Defines:
#  MATLAB_FOUND: indicates that the libraries and include directory were found
...
# This file in Katydid is a derivative work of file FindMatlab.cmake from https://github.com/elador/FeatureDetection
#
...
message(STATUS "Using LOCAL FindMatlab.cmake")
...
ELSE(WIN32)
  ...
  IF(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    ...
    IF((NOT DEFINED MATLAB_ROOT) OR ("${MATLAB_ROOT}" STREQUAL ""))
      ...
      FOREACH(MATVER "v83" "v82" "v81" "v80")
        IF((NOT DEFINED MATLAB_ROOT) OR ("${MATLAB_ROOT}" STREQUAL ""))
          #message(STATUS "checking for /Applications/MATLAB/MATLAB_Compiler_Runtime/${MATVER}")
          IF(EXISTS /Applications/MATLAB/MATLAB_Compiler_Runtime/${MATVER})
            SET(MATLAB_ROOT /Applications/MATLAB/MATLAB_Compiler_Runtime/${MATVER})
    
          ENDIF(EXISTS /Applications/MATLAB/MATLAB_Compiler_Runtime/${MATVER})
