...
namespace Katydid
{
            ...
            fNormalization(NULL)
    {
        ...
        RegisterSlot("freq_spect", this, &KTOldGainNormalization::ProcessFrequencySpectrum, "void (UInt_t, KTFrequencySpectrumPolar*)");
    }
    ...
    void KTOldGainNormalization::PrepareNormalization(KTFrequencySpectrumPolar* fullArray, UInt_t reducedNBins, Double_t reducedBinWidth)
    {
        delete fNormalization;
        fNormalization = new KTFrequencySpectrumPolar(reducedNBins, -0.5*reducedBinWidth, reducedBinWidth * ((Double_t)reducedNBins-0.5));
    ...
    void KTOldGainNormalization::ProcessFrequencySpectrum(UInt_t /*psNum*/, KTFrequencySpectrumPolar* freqSpectrum)
    {
