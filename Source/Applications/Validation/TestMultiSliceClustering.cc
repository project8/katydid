...
int main()
{
    ...
    freqPoints.clear();
    // time bin 9
    freqPoints.insert(pair< unsigned, double >(2, 2.)); // this point should be clustered with the point in the next time bin
    allPoints.push_back(freqPoints);
    freqPoints.clear();
    // time bin 10
    freqPoints.insert(pair< unsigned, double >(2, 2.)); // this point should be clustered with the point in the previous time bin
    allPoints.push_back(freqPoints);
