/**
 @file KTMultiChannelInnerProduct.hh
 @brief Contains KTMultiChannelInnerProduct
 @details Applies the Matched Filter inner product for multiple channels
 @author: F. Thomas
 @date: Apr 28, 2021
 */

#ifndef KTMULTICHANNELINNERPRODUCT_HH_
#define KTMULTICHANNELINNERPRODUCT_HH_
...
namespace Katydid
{
    ...
    /*!
     @class KTMultiChannelInnerProduct
     @author F. Thomas
    ...
    */
    class KTMultiChannelInnerProduct : public Nymph::KTProcessor
    {
        public:
            KTMultiChannelInnerProduct(const std::string& name = "multi-channel-inner-product");
            virtual ~KTMultiChannelInnerProduct();
...
#endif /* KTMULTICHANNELINNERPRODUCT_HH_ */
