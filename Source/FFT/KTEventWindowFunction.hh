   ...
   class KTEventWindowFunction : public KTWindowFunction
    {
        public:
            ...
            KTEventWindowFunction(const KTTimeSeriesChannelData* tsData);
            ...
            virtual Double_t AdaptTo(const KTTimeSeriesChannelData* tsData);
            ...
            /// Returns the adapted length.
            virtual Double_t AdaptTo(const KTTimeSeriesChannelData* tsData, Double_t length);
