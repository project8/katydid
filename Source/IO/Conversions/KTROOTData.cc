...
namespace Katydid
{
    ...
    //         fComponent(orig.fComponent), fAcquisitionID(orig.fAcquisitionID), fCandidateID(orig.fCandidateID),
    //         fStartTimeInRunC(orig.fStartTimeInRunC), fEndTimeInRunC(orig.fEndTimeInRunC), fStartTimeInAcq(orig.fStartTimeInAcq), fStartFrequency(orig.fStartFrequency), fEndFrequency(orig.fEndFrequency), fInitialSlope(orig.fInitialSlope), fSlope(orig.fSlope), 
