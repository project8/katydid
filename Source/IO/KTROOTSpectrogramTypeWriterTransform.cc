...
namespace Katydid
{
    ...
    void KTROOTSpectrogramTypeWriterTransform::StartNewHistograms()
    {
        ClearHistograms();
        // At this point the vectors are size 0
        return;
    }

    void KTROOTSpectrogramTypeWriterTransform::FinishHistograms()
    {
        OutputHistograms();
        ClearHistograms();
        return;
    ...
    void KTROOTSpectrogramTypeWriterTransform::OutputHistograms()
    {
    ...
    void KTROOTSpectrogramTypeWriterTransform::ClearHistograms()
    {
