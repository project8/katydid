...
#ifndef __KTHDF5TWA_HH
#define __KTHDF5TWA_HH
...
namespace Katydid {
	...
	class KTHDF5TypeWriterAnalysis: public KTHDF5TypeWriter {
		/* constructors/destructors/katydid boilerplate */
	public:
		KTHDF5TypeWriterAnalysis();
		virtual ~KTHDF5TypeWriterAnalysis();
