...
namespace Katydid
{
    ...
    */
    ...
    /*
     ...
     @details
     Initializes and trains SVM classifier at runtime; classifies incoming tracks into three groups

     Available configuration values:
     - "algortihm": std::string -- machine-learning algorithm used to generated the XML file
     - "c": double -- c-hyperparameter in SVM
     - "gamma": double -- gamma-hyperparameter in SVM
     - "training-set": std:;string -- location of file with training data

     Slots:
     - "power-fit": void (Nymph::KTDataPtr) -- Performs MVA analysis with the rotated-and-projected parameters; Requires KTProcessedTrackData and KTPowerFitData; Adds KTClassifierResultsData
