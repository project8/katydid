...
namespace Katydid
{
    ...
    bool KTTrackProcessing::ProcessTrackWeightedSlope(KTSparseWaterfallCandidateData& swfData, KTHoughData& htData)
    {
        ...
        //         {
        //             if (pIt->fTimeInRunC == TimeBin[i])
        //             {
        //                 if (pIt-> )
        //               sumPf[i] += pIt->fFrequency * pIt->fAmplitude;
        //               sumP[i] += pIt->fFrequency * pIt->fAmplitude;
        //             }
        //         }
        //     }
        //     else
        //     {
        //       TimeBin.push_back(pIt->fTimeInRunC);
        //       sumPf.push_back(pIt->fFrequency * pIt->fAmplitude);
        //       sumP.push_back(pIt->fAmplitude);
        //     }
        // }
