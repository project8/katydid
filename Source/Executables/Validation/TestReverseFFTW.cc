...
int main()
{
    ...
    LINFO(vallog, "Testing the 1D complex-to-complex rFFT\n" <<
    ...
    {
        LERROR(vallog, "Error while initializing the FFT");
        exit(-1);
    }
    ...
    LINFO(vallog, "Using Parceval's theorem to check the normalization of the transform.\n"
