...
namespace Katydid
{
    ...
    /*!
     ...
     - "number-of-slices": unsigned -- Number of slices to process (set to 0 to process all slices in the file)
     ...
     - "egg-reader": string -- Egg reader to use.
        ...
        - "egg2" - Uses the monarch2 library to read Egg files
     ...
     - -m (metadata-file): Metadata filename to use
