...
<<<<<<< HEAD
     - "egg-reader": string -- Egg reader to use.  Options: "monarch" [default], "2011", "rsamat")
        - "monarch" [default] - Uses the monarch library and classes to read Egg files
        - "2011" - uses the old style Egg reader, which opens and reads the contents of the Egg file directly
        - "rsamat" - reads matlab (mat) files generated by the Tektronix RSA, and stores the header and data into Egg classes as if it was an Egg file, allowing for seamless processing of the data
=======
