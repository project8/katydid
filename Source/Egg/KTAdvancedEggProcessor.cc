/**
 ...
 @details KTAdvancedEggProcessor iterates over the events in an Egg file
 @author: N. S. Oblath
 @date: Jan 5, 2012
 */

#include "KTAdvancedEggProcessor.hh"
...
namespace Katydid
{
    ...
    KTAdvancedEggProcessor::KTAdvancedEggProcessor() :
            KTProcessor(),
            KTConfigurable(),
            fNEvents(0),
            fFilename(""),
    ...
    Bool_t KTAdvancedEggProcessor::Configure(const KTPStoreNode* node)
    {
    ...
    Bool_t KTAdvancedEggProcessor::ProcessEgg()
    {
        KTEgg egg;
