...
//        double scaling = 1. / KTPowerSpectrum::GetResistance() / (double)GetNTimeBins(); //This scaling term is already included in KTChirpSpaceFFT::CreatePowerSpectrum() and is not needed here.
	double scaling = 1.;
